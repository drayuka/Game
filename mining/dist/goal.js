...
class goal {
    ...
    constructor(job, roomName, target, meta) {
        var self = this;
    ...
    get target() {
        ...
        self._target = Game.getObjectById(self.id);
        if (!self._target) {
    ...
    set permanentPositions(positions) {
        ...
        self.meta.positions = null;
        self.meta.range = null;
    }
    get permanentPositions() {
        var self = this;
        return _.map(self.meta.permanentPositions, function (pos) {
    ...
    get positions() {
        ...
        if (self.meta.positions) {
            self._positions = _.map(self.meta.positions, function (pos) {
                return new RoomPosition(pos[0], pos[1], self.roomName);
            });
            return self._positions;
        }
