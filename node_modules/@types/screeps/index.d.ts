...
// Source: https://raw.githubusercontent.com/screepers/typed-screeps/master/dist/screeps.d.ts
declare const OK: 0;
...
interface RoomObject {
    ...
    room: Room | undefined;
    /**
     * id is not actually on all room objects, it doesn't appear on flags, however 
     * this is an annoying oversight that causes problems, so we're going to ignore it
     */
    id: string;
}
